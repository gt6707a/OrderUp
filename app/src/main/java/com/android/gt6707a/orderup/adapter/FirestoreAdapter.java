 ...
 *
 * <p>See the adapter classes in FirebaseUI
 * (https://github.com/firebase/FirebaseUI-Android/tree/master/firestore) for a more efficient
 * implementation of a Firestore RecyclerView Adapter.
 */
